...
export type Notification={id:string;user_id:string;actor_id:string|null;type:'encouragement'|'reaction';encouragement_id:string|null;reaction_id:string|null;title:string;body:string;read_at:string|null;created_at:string};
