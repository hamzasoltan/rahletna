...
export type Goal={id:string;user_id:string;title:string;description:string|null;start_date:string|null;target_date:string|null;steps_repeat_daily:boolean;status:'active'|'completed'|'paused';created_at:string;updated_at:string};
...
export type GoalStepLog={id:string;milestone_id:string;goal_id:string;user_id:string;log_date:string;completed:boolean;created_at:string;updated_at:string};
