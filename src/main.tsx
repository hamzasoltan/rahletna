...
return <Shell user={user} profile={profile} partner={partner!} view={view} setView={setView} dark={dark} setDark={setDark} onLogout={()=>supabase.auth.signOut()}><Dashboard user={user} profile={profile} partner={partner!} view={view} onProfileUpdated={setProfile}/></Shell>}
...
const refresh=async()=>{
  ...
  const [a,b,g,h,e]=await Promise.all([
